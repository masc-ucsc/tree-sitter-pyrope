...
typedef enum {
  ...
  anon_sym_LT_LT = 87,
  anon_sym_GT_GT = 88,
  anon_sym_BANG_AMP = 89,
  anon_sym_BANG_PIPE = 90,
  anon_sym_BANG_CARET = 91,
  anon_sym_DOT_DOT_EQ = 92,
  anon_sym_DOT_DOT_LT = 93,
  anon_sym_DOT_DOT_PLUS = 94,
  anon_sym_step = 95,
  anon_sym_implies = 96,
  anon_sym_BANGimplies = 97,
  anon_sym_proc = 98,
  anon_sym_pipe = 99,
  ...
  anon_sym_AMP_EQ = 105,
  anon_sym_CARET_EQ = 106,
  anon_sym_LT_LT_EQ = 107,
  anon_sym_GT_GT_EQ = 108,
  anon_sym_PLUS_PLUS_EQ = 109,
  anon_sym_or_EQ = 110,
  anon_sym_and_EQ = 111,
  anon_sym_DOT_DOT = 112,
  anon_sym_uint = 113,
  anon_sym_unsigned = 114,
  aux_sym_uint_type_token1 = 115,
  anon_sym_int = 116,
  anon_sym_integer = 117,
  aux_sym_sint_type_token1 = 118,
  sym_bool_type = 119,
  sym_string_type = 120,
  sym__simple_number = 121,
  sym__scaled_number = 122,
  sym__hex_number = 123,
  sym__decimal_number = 124,
  sym__octal_number = 125,
  sym__binary_number = 126,
  sym__typed_number = 127,
  sym_bool_literal = 128,
  sym_string_literal = 129,
  anon_sym_DQUOTE = 130,
  aux_sym_interpolated_string_literal_token1 = 131,
  aux_sym_interpolated_string_literal_token2 = 132,
  sym__format_spec = 133,
  sym__space = 134,
  sym_comment = 135,
  anon_sym_when = 136,
  anon_sym_unless = 137,
  sym__automatic_semicolon = 138,
  sym_description = 139,
  sym__statement = 140,
  ...
  sym__attr_prefix = 151,
  sym__init_clause = 152,
  sym_for_statement = 153,
  sym_while_statement = 154,
  sym_loop_statement = 155,
  sym_match_expression = 156,
  sym_test_statement = 157,
  sym_type_statement = 158,
  sym_impl_statement = 159,
  sym_expression_list = 160,
  sym_function_call_expression = 161,
  sym_tuple = 162,
  sym_tuple_sq = 163,
  sym__tuple_list = 164,
  sym__tuple_item = 165,
  ...
  sym_lambda = 206,
  sym_pipe_lambda = 207,
  sym_assignment_operator = 208,
  sym_select = 209,
  sym_selection_range = 210,
  sym_type_cast = 211,
  sym__type = 212,
  sym_expression_type = 213,
  sym_dot_expression_type = 214,
  sym_function_call_type = 215,
  sym_array_type = 216,
  sym__primitive_type = 217,
  sym_uint_type = 218,
  sym_sint_type = 219,
  sym_constant = 220,
  sym_integer_literal = 221,
  sym_unknown_literal = 222,
  sym__string_literal = 223,
  sym_interpolated_string_literal = 224,
  sym__semicolon = 225,
  sym_when_unless_cond = 226,
  aux_sym_description_repeat1 = 227,
  aux_sym_description_repeat2 = 228,
  aux_sym_scope_statement_repeat1 = 229,
  aux_sym_import_statement_repeat1 = 230,
  aux_sym_stmt_list_repeat1 = 231,
  aux_sym_if_expression_repeat1 = 232,
  aux_sym_match_expression_repeat1 = 233,
  aux_sym_expression_list_repeat1 = 234,
  aux_sym__tuple_list_repeat1 = 235,
  aux_sym__tuple_list_repeat2 = 236,
  aux_sym_lvalue_list_repeat1 = 237,
  aux_sym_attribute_list_repeat1 = 238,
  aux_sym_arg_list_repeat1 = 239,
  aux_sym_typed_identifier_list_repeat1 = 240,
  aux_sym_member_selection_repeat1 = 241,
  aux_sym_attribute_read_repeat1 = 242,
  aux_sym__binary_times_repeat1 = 243,
  aux_sym__binary_other_repeat1 = 244,
  aux_sym__binary_compare_repeat1 = 245,
  aux_sym__binary_logical_repeat1 = 246,
  aux_sym_dot_expression_repeat1 = 247,
  aux_sym_dot_expression_type_repeat1 = 248,
  aux_sym_interpolated_string_literal_repeat1 = 249,
  alias_sym_assign = 250,
  alias_sym_op_add = 251,
  alias_sym_op_bit_and = 252,
  alias_sym_op_bit_or = 253,
  alias_sym_op_bit_xor = 254,
  alias_sym_op_case = 255,
  alias_sym_op_does = 256,
  alias_sym_op_eq = 257,
  alias_sym_op_equals = 258,
  alias_sym_op_ge = 259,
  alias_sym_op_gt = 260,
  alias_sym_op_has = 261,
  alias_sym_op_in = 262,
  alias_sym_op_is = 263,
  alias_sym_op_le = 264,
  alias_sym_op_log_and = 265,
  alias_sym_op_log_nand = 266,
  alias_sym_op_log_nor = 267,
  alias_sym_op_log_or = 268,
  alias_sym_op_lt = 269,
  alias_sym_op_ne = 270,
  alias_sym_op_not_case = 271,
  alias_sym_op_not_does = 272,
  alias_sym_op_not_equals = 273,
  alias_sym_op_not_has = 274,
  alias_sym_op_not_in = 275,
  alias_sym_op_not_is = 276,
  alias_sym_op_range_exclusive = 277,
  alias_sym_op_range_inclusive = 278,
  alias_sym_op_spread = 279,
  alias_sym_op_sub = 280,
  alias_sym_open_all = 281,
  alias_sym_reduction_and = 282,
  alias_sym_reduction_or = 283,
  alias_sym_reduction_xor = 284,
  alias_sym_reg_decl = 285,
} PyropeSymbol;
